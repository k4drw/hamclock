...
typedef enum { SDOT_COMP, SDOT_HMIB, SDOT_HMIIC, SDOT_131, SDOT_193, SDOT_211, SDOT_304, SDOT_N } SDOImgType;

static const char* sdo_menu[SDOT_N] = {
    "Composite", "Magnetogram", "6173A", "131A", "193A", "211A", "304A",
};
...
static const char* sdo_file[SDOT_N] = {
    ...
    "f_211_193_171_340.bmp", "latest_340_HMIB.bmp", "latest_340_HMIIC.bmp", "f_131_340.bmp",
    "f_193_340.bmp",         "f_211_340.bmp",       "f_304_340.bmp",
#elif defined(_CLOCK_2400x1440)
    "f_211_193_171_510.bmp", "latest_510_HMIB.bmp", "latest_510_HMIIC.bmp", "f_131_510.bmp",
    "f_193_510.bmp",         "f_211_510.bmp",       "f_304_510.bmp",
#elif defined(_CLOCK_3200x1920)
    "f_211_193_171_680.bmp", "latest_680_HMIB.bmp", "latest_680_HMIIC.bmp", "f_131_680.bmp",
    "f_193_680.bmp",         "f_211_680.bmp",       "f_304_680.bmp",
#else
    "f_211_193_171_170.bmp", "latest_170_HMIB.bmp", "latest_170_HMIIC.bmp", "f_131_170.bmp",
    "f_193_170.bmp",         "f_211_170.bmp",       "f_304_170.bmp",
#endif
};
...
static bool drawSDOImage(const SBox& box) {
    ...
    if (need_fresh) {
        ...
        if (!ok) plotMessage(box, SDO_COLOR, "SDO download failed");
    }
 ...
 */
static void showSDOmovie(void) { openURL(sdo_url[sdo_choice]); }
...
#define SM_INDENT 5
    ...
    enum { SDOM_ROTATE = SDOT_N, SDOM_GAP, SDOM_GRAYLINE, SDOM_SHOWWEB, SDOM_NMENU };
    ...
    if (ok) {
        ...
        // check for movie
        if (mitems[SDOM_SHOWWEB].set) showSDOmovie();
    ...
    if (refresh_pane) scheduleNewPlot(PLOT_CH_SDO);
